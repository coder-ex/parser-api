...
class OzonLoadStatFoodCampaign extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'ozon:stat-food-campaign
    ...
    public function handle()
    {
        ...
        $task = $this->systemService->getTaskOne($typeDB, $project_id, TypeTask::StatFoodCampaign->value);
        if (is_null($task)) {
