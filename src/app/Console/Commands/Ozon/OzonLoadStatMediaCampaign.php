...
class OzonLoadStatMediaCampaign extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'ozon:stat-media-campaign
    ...
    public function handle()
    {
        ...
        $task = $this->systemService->getTaskOne($typeDB, $project_id, TypeTask::StatMediaCampaign->value);
        if (is_null($task)) {
